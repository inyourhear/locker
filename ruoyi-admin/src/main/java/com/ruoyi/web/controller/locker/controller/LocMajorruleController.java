...
public class LocMajorruleController extends BaseController
{
    ...
    @Log(title = "专业规则信息", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    @ResponseBody
    ...
    @Log(title = "专业规则信息", businessType = BusinessType.INSERT)
    @PostMapping("/add")
    @ResponseBody
    ...
    @Log(title = "专业规则信息", businessType = BusinessType.UPDATE)
    @PostMapping("/edit")
    @ResponseBody
    ...
    @Log(title = "专业规则信息", businessType = BusinessType.DELETE)
    @PostMapping( "/remove")
    @ResponseBody
